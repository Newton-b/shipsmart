...
class UpdateUserDto extends (0, swagger_1.PartialType)(create_user_dto_1.CreateUserDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return { isActive: { required: false, type: () => Boolean }, emailVerified: { required: false, type: () => Boolean }, timezone: { required: false, type: () => String }, language: { required: false, type: () => String }, avatar: { required: false, type: () => String }, notificationPreferences: { required: false, type: () => ({ email: { required: true, type: () => Boolean }, sms: { required: true, type: () => Boolean }, push: { required: true, type: () => Boolean }, shipmentUpdates: { required: true, type: () => Boolean }, paymentAlerts: { required: true, type: () => Boolean }, marketingEmails: { required: true, type: () => Boolean } }) } };
    }
}
