...
export const FreightFooter: React.FC<FreightFooterProps> = ({ onContactClick, onNavigate, onPageNavigate }) => {
  ...
  const socialLinks = [
    { icon: Linkedin, url: 'https://linkedin.com/company/raphtrack', label: 'LinkedIn' },
    { icon: Twitter, url: 'https://twitter.com/raphtrack', label: 'Twitter' },
    { icon: Facebook, url: 'https://facebook.com/raphtrack', label: 'Facebook' },
    { 
      ...
      url: 'https://instagram.com/raphtrack', 
      label: 'Instagram' 
    },
    { 
      icon: ({ className }: { className?: string }) => (
      ...
      url: 'https://tiktok.com/@raphtrack', 
      label: 'TikTok' 
    }
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="ml-3 text-2xl font-bold">RaphTrack</span>
            </div>
